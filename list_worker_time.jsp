...
<!-- Header -->
	...
	<form method="post" action = "list_worker_time.jsp">
		<fieldset id="regbox">
				<label for="id">가능시간대</label><input type="text" name="name"/><br />
	...
	<table border="1" width="600">
		...
		<%
			...
			try {
				...
				String sql = "select w.worker_id, w.worker_number, w.worker_region, w.worker_time, w.type, w.wage, w.workday from workers w where w.worker_time=?";

...
<!-- Header -->
				...
				<h2>회사목록 </h2>
	<form method="post" action = "list_firm_wage.jsp">
		<fieldset id="regbox">
	...
	<%
		...
		String firm_wage = request.getParameter("name"); 
	%>
		...
		<%
			...
			try {
				...
				String sql = "select f.firm_id, f.firm_number, f.firm_region, f.firm_time, f.type, f.wage, f.workday from firm f where f.wage>=?";
				pstmt = con.prepareStatement(sql);
				pstmt.setString(1,firm_wage);
